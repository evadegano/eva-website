    ...
    <Layout home>
      ...
      <section className={utilStyles.columnContainerLeft}>
        ...
        <p>
          ...
          <br/><span className={utilStyles.markedText}>I deeply value learning and sharing knowledge through content and tools that improve people's lives.</span> 
          <br/>And tech is what makes it possible at scale.
